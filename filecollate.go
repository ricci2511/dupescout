...
func (dup *filecollate) consumePairs(dupesChan chan []string, stream bool) {
...
func (dup *filecollate) producePair(path string) error {
	if dup.shuttingDown() {
...
func (dup *filecollate) search(dir string) error {
...
func (dup *filecollate) shuttingDown() bool {
	select {
	case <-dup.shutdown:
		return true
	default:
